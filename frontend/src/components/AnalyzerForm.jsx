...
export default function AnalyzerForm({
    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            >
                Audio File<span className="text-caution-500">*</span>
            </label>
            <div
                ...
                className={`group border-2 border-dashed rounded-xl p-6 mt-2 text-center cursor-pointer transition-colors ${isDragging
                    ...
                    : 'border-brand-300 text-paper-500 hover:bg-brand-50'
                    }`}
            >
                <input
                    type="file"
                ...
                <label
                    htmlFor="audio-upload"
                    className="block cursor-pointer text-brand-600 font-semibold mt-2"
                >
                    <FontAwesomeIcon
                        icon={"cloud-arrow-up"}
                        className="text-brand-500 text-5xl mb-4 group-hover:scale-[1.2] transition-transform duration-300"
                    />
            ...
            <div className="mt-5">
                ...
                <textarea
                    ...
                    value={prompt}
                    required
                    className="w-full mt-2 p-2 border rounded-xl bg-paper-50 font-[400]"
                    id="prompt"
                    rows="3"
            ...
            <div className="mt-5">
                ...
                <textarea
                    ...
                    value={rubric}
                    required
                    className="w-full mt-2 p-2 border rounded-xl bg-paper-50"
                    id="rubric"
                    rows="3"
            ...
            <Button
                ...
                className="mt-7 mb-2 w-full px-6 py-2 rounded-3xl disabled:bg-ink-400 disabled:cursor-not-allowed"
            >
                {isLoading ? (
                    "Analyzing..."
                ) : isUploadingAudio ? (
